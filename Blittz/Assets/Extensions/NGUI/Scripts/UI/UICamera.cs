...
public class UICamera : MonoBehaviour
{
	...
	/// <summary>
	/// PlayerName of the axis used for scrolling.
	/// </summary>

	public string scrollAxisName = "Mouse ScrollWheel";

	/// <summary>
	/// PlayerName of the axis used to send up and down key events.
	/// </summary>

	public string verticalAxisName = "Vertical";

	/// <summary>
	/// PlayerName of the axis used to send left and right key events.
	/// </summary>
