...
public class UIAtlas : MonoBehaviour
{
	...
	// Material used by this atlas. PlayerName is kept only for backwards compatibility, it used to be public.
	[HideInInspector][SerializeField] Material material;

	// List of all sprites inside the atlas. PlayerName is kept only for backwards compatibility, it used to be public.
