...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class NguiPlayTween : FsmStateAction
	{
		...
		//void Start () { mStarted = true; if (tweenTarget == null) tweenTarget = InGameObject; }

		//void OnEnable () { if (mStarted && mHighlighted) OnHover(UICamera.IsHighlighted(InGameObject)); }
		...
		public override void OnEnter()
		{
			...
			{
				LogWarning("no InGameObject target to tween");
				return;
			}
