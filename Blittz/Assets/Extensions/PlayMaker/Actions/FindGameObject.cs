...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Finds a Game Object by PlayerName and/or Tag.")]
	public class FindGameObject : FsmStateAction
	{
		...
		[UIHint(UIHint.Tag)]
        [Tooltip("Find a GameObject with this tag. If Object PlayerName is specified then both name and Tag must match.")]
		...
		public override string ErrorCheck()
		{
			...
			{
			    return "Specify PlayerName, Tag, or both.";
			}
