...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Finds the Child of a GameObject by PlayerName and/or Tag. Use this to find attach points etc. NOTE: This action will search recursively through all children and return the first match; To find a specific child use Find Child.")]
	public class GetChild : FsmStateAction
	{
		...
		[UIHint(UIHint.Tag)]
        [Tooltip("The Tag to search for. If Child PlayerName is set, both name and Tag need to match.")]
		...
		public override string ErrorCheck()
		{
			...
			{
				return "Specify Child PlayerName, Tag, or both.";
			}
			return null;
		}
