...
{
	private Color LightOrange = new Color(1f,0.7f,0f);
	...
	public override void OnInspectorGUI()
    {
		...
		if (_target.targetFSM == null)
		{
			...
			if (_targetFsm!=null)
			{
				PlayMakerFSM _newTargetFSM = (PlayMakerFSM)EditorGUILayout.ObjectField("The Target defaults to",_targetFsm,typeof(PlayMakerFSM),true);	
			...
			_target.targetFSM = (PlayMakerFSM)EditorGUILayout.ObjectField("Fsm Target",_targetFsm,typeof(PlayMakerFSM),true);	
		}
