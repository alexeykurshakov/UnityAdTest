...
public class AudioController : SingletonMonoBehaviour<AudioController>
{
    ...
    /// </summary>
    /// <param name="categoryName">PlayerName of category.</param>
    /// <param name="fadeOutLength">The fade-out time [Default=0]</param>
    ...
    /// </summary>
    /// <param name="categoryName">PlayerName of the category.</param>
    /// <returns>
    ...
    /// </summary>
    /// <param name="categoryName">PlayerName of the category to remove.</param>
    ...
    /// </summary>
    /// <param name="audioID">PlayerName of the audio item to remove.</param>
    ...
    public AudioObject PlayAudioItem( AudioItem sndItem, float volume, Vector3 worldPosition, Transform parentObj = null, float delay = 0, float startTime = 0, bool playWithoutAudioObject = false, AudioObject useExistingAudioObj = null, double dspTime = 0)
    {
        ...
        //Debug.Log( "PlayAudioItem '" + sndItem.PlayerName + "'" );
