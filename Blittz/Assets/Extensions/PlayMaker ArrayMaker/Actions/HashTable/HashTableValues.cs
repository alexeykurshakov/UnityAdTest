...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class HashTableValues : HashTableActions
	{
		...
		[RequiredField]
		[Tooltip("The InGameObject with the PlayMaker HashTable Proxy component")]
		...
		[RequiredField]
		[Tooltip("The InGameObject with the PlayMaker ArrayList Proxy component that will store the values")]
