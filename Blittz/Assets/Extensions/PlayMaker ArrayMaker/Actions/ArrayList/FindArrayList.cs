...
// ArrayList actions requires both a InGameObject AND a reference. 
// If only one arrayList is attached to a InGameObject, and the reference name is left blank, referencing is not necessary.
