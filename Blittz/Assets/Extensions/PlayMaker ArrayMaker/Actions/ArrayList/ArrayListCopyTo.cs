...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class ArrayListCopyTo : ArrayListActions
	{
		...
		[RequiredField]
		[Tooltip("The InGameObject with the PlayMaker ArrayList Proxy component to copy from")]
		...
		[RequiredField]
		[Tooltip("The InGameObject with the PlayMaker ArrayList Proxy component to copy to")]
		[CheckForComponent(typeof(PlayMakerArrayListProxy))]
