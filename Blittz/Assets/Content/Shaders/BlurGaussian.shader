Shader "Blur/Gaussian"
{
    Properties
    {
		_blurSizeXY("BlurSizeXY", Range(0.0, 20.0)) = 0.0
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			half4 frag( v2f i ) : COLOR
			{
				...
				float depth = _blurSizeXY * 0.0005 * _Color.a;
			
			    screenPos.x = (screenPos.x + 1) * 0.5;
			    #if defined(SHADER_API_OPENGL) || defined(SHADER_API_MOBILE)
